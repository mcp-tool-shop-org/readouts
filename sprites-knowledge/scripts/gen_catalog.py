...
def main():
    ...
    idx = [f"# Catalog — sprite-pipeline recipes (mesh · render · downsample · NVS · sheets · eval · animation)\n",
           ...
           "(RTX 5090 · Blackwell · 32 GB · Win 11 / WSL2). Sibling KBs: "
           ...
           "[training-knowledge](../../training-knowledge/catalog/README.md) (the *training craft*). This one owns the "
           "*sprite-pipeline recipes* — and points at measured numbers via `engine_recipe_ref` (tensor-engine) and base "
           "weights via `base_model_slug` (model-knowledge), never restating them.\n"]
