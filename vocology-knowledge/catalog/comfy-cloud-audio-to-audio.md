...
- **Implication:** STUDY-043 Comfy Cloud a2a docs. Nodes invented: 0. Cover/Repaint not live Comfy nodes. Flips beyond ACCEPT: 0.
- **Verify:** no external verdict — not yet swept

### ACE-Step 1.5 guide · `directional`
**Cover and Repaint available in ACE-Step 1.5 but not yet supported in ComfyUI — do not invent as live Comfy nodes. Explicitly lists **Cover** and **Repaint** as “available in ACE-Step 1.5 but not yet supported in ComfyUI.” Cloud note: “Cloud will update after ComfyUI stable release.” Do not treat Cover/Repaint as live Comfy nodes.**
- **Implication:** STUDY-043 Comfy Cloud a2a docs. Nodes invented: 0. Cover/Repaint not live Comfy nodes. Flips beyond ACCEPT: 0.
